...
# StructureDataset Zero marking and the order of core arguments
...
[prov:wasDerivedFrom](http://www.w3.org/ns/prov#wasDerivedFrom) | <ol><li><a href="https://github.com/cldf-datasets/sinnemakizeromarking/tree/2dd1af1">cldf-datasets/sinnemakizeromarking v1.0-1-g2dd1af1</a></li><li><a href="https://github.com/glottolog/glottolog/tree/v5.2">Glottolog v5.2</a></li></ol>
...
[dc:extent](http://purl.org/dc/terms/extent) | 5961
...
`Area` | `string` | 
`Continent` | `string` | 
`Macrocontinent` | `string` | 
`Macrocontinent_SplitOldWorld` | `string` | 
`Circumpacific` | `string` | 
[Source](http://cldf.clld.org/v1.0/terms.rdf#source) | list of `string` (separated by `;`) | References [sources.bib::BibTeX-key](./sources.bib)
`Source_prose` | `string` | 
